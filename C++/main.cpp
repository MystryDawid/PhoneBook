...
HANDLE uchwytDoKonsoli = GetStdHandle( STD_OUTPUT_HANDLE );//Pobiera uchwyt do określonego urządzenia (standardowe wejście, standardowe wyjście, standardowe wyjście błędów).
